...
def filter_by_threshold(documents, distances, threshold=SIMILARITY_THRESHOLD):
    ...
    """
    # TODO (Week 14): Implement similarity threshold filtering. (Done)
...
def get_fallback_response():
    ...
    """
    # TODO (Week 14): Write a graceful fallback message. (Done)
    return "No relevant information found. Please try rephrasing your query or ask about supported topics (Python, machine learning, databases, APIs, AI concepts)."
